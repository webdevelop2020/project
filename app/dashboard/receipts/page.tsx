            ...
            <table className="w-full table-auto border-collapse">
              ...
              <tbody>
                {users.map((user, index) => (
                  <tr key={user.id} className="border-b border-gray-200 dark:border-[#2E3A4D] last:border-b-0">
                    ...
                    <td className="px-4 py-5 border-r border-gray-200 dark:border-[#2E3A4D]">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h5 className="text-[14px] leading-[20px] font-normal text-gray-900 dark:text-white">{user.name}</h5>
                          <p className="text-[14px] leading-[20px] font-normal text-gray-500 dark:text-[#8A99AF]">{user.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-5 border-r border-gray-200 dark:border-[#2E3A4D]">
                      <p className="text-[14px] leading-[20px] font-normal text-gray-900 dark:text-white">{user.position}</p>
                    </td>
                    <td className="px-4 py-5 border-r border-gray-200 dark:border-[#2E3A4D]">
                      <p className="text-[14px] leading-[20px] font-normal text-gray-900 dark:text-white">${user.salary.toLocaleString()}</p>
                    </td>
                    <td className="px-4 py-5 border-r border-gray-200 dark:border-[#2E3A4D]">
                      <p className="text-[14px] leading-[20px] font-normal text-gray-900 dark:text-white">{user.office}</p>
                    </td>
                    <td className="px-4 py-5 border-r border-gray-200 dark:border-[#2E3A4D]">
